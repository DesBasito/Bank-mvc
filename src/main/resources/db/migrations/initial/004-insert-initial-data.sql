...
VALUES (1, 'USER', 'Regular user'),
       (2, 'ADMIN', 'System administrator');

SELECT setval('roles_id_seq', 2, true);

-- All user password's is - qwe
...
VALUES (1, 3, 1000.00, 'Transfer to friend', 'SUCCESS', NOW() - INTERVAL '2 days'),
       (3, 1, 500.00, 'Return of debt', 'SUCCESS', NOW() - INTERVAL '1 day'),
       (1, 5, 750.50, 'Payment for services', 'SUCCESS', NOW() - INTERVAL '3 hours'),
       (5, 1, 200.00, 'Payment for purchases', 'SUCCESS', NULL),
       (3, 6, 1500.00, 'Blocked card transfer', 'CANCELLED', NOW() - INTERVAL '1 hour'),
       (1, 3, 100.00, 'Test transfer', 'REFUNDED', NOW() - INTERVAL '6 hours');
